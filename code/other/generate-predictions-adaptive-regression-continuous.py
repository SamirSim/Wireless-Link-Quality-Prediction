...
# Adaptive Regression
filename = '../data/comprehensive-regression-models-continuous.json'
with open(filename, 'r') as file:
    result = json.load(file)
            ...
            for key_2, value_2 in value.items():
                try:
                    for key_3, value_3 in value_2.items():
                        ...
                        while index <= len(test):
                            ...
                            for elem in value_3: # Loop over all regressors
                                ...
                                try:
                                    ...
                                    mse = mean_squared_error(test[index:index+1], elem_)
                        ...
                        res[key_3] = {"mse": mse, "mae": mae, "predictions": final_predictions}
...
filename = "predictions-adaptive-regression-continuous.json"
print(cluster_data)
#print(filename)
