        ...
        for regressor_string in regressor_strings: # Changed here to keep the best regressor and window step
            ...
            while index < len(test):
                ...
                try:
                    ...
                    mse_list.append(mean_squared_error(test[index:index+prediction_step], predictions))
                    mae_list.append(mean_absolute_error(test[index:index+prediction_step], predictions))
            ...
            regressor_results.append({"regressor": str(regressor), "window_step": window_step, "MAE": mae_list, "MSE": mse_list, "predictions": predictions})
...
filename = "comprehensive-regression-models-continuous"
